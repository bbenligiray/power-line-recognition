...
def densenet161_model(img_rows, img_cols, color_type=1, nb_dense_block=4, growth_rate=48, nb_filter=96, reduction=0.5, dropout_rate=0.0, weight_decay=1e-4, num_classes=None):
    ...
    x_fc = Dense(1000, name='fc6', kernel_regularizer=l2(weight_decay))(x_fc)
    ...
    x_newfc = Dense(num_classes, name='fc6', kernel_regularizer=l2(weight_decay))(x_newfc)
...
def conv_block(x, stage, branch, nb_filter, dropout_rate=None, weight_decay=1e-4):
    ...
    x = Conv2D(inter_channel, (1, 1), name=conv_name_base+'_x1', use_bias=False,
                kernel_regularizer=l2(weight_decay))(x)
    ...
    x = Conv2D(nb_filter, (3, 3), name=conv_name_base+'_x2', use_bias=False,
                kernel_regularizer=l2(weight_decay))(x)
